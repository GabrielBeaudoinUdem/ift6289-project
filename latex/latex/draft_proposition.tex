...
\author{
    ...
    \\
    \textsuperscript{1}na.an.1@umontreal.ca,
...
mapping. For example, evaluated models got an average $47.8\%$ accuracy score
on 
tasks about synonyms, which often implies more knowledge of the source language
than simple morphological relations. Similarly, \citet{liEvaluationCompetenceLexicale2025}
used 82 LFs to 
compared language models, with similar conclusions.
